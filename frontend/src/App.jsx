  ...
  <div className="container">
    ...
    <div id="logo" className="pull-left">
     ...
     - <h1><a href="#main">C<span>o</span>nf</a></h1>
      <a href="#intro" className="scrollto"><img src="../public/assets/img/logo.png" alt="" title=""/></a>
    </div>
...
<main id="main">
      ...
      <div className="row">
        <div className="col-lg-4 col-md-6">
          <div className="speaker">
            <img src="../public/assets/img/speakers/1.jpg" alt="Speaker 1" className="img-fluid"/>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="speaker">
            <img src="../public/assets/img/speakers/2.jpg" alt="Speaker 2" className="img-fluid"/>
            <div className="details">
        ...
        <div className="col-lg-4 col-md-6">
          <div className="speaker">
            <img src="../public/assets/img/speakers/3.jpg" alt="Speaker 3" className="img-fluid"/>
            <div className="details">
        ...
        <div className="col-lg-4 col-md-6">
          <div className="speaker">
            <img src="../public/assets/img/speakers/4.jpg" alt="Speaker 4" className="img-fluid"/>
            <div className="details">
        ...
        <div className="col-lg-4 col-md-6">
          <div className="speaker">
            <img src="../public/assets/img/speakers/5.jpg" alt="Speaker 5" className="img-fluid"/>
            <div className="details">
        ...
        <div className="col-lg-4 col-md-6">
          <div className="speaker">
            <img src="../public/assets/img/speakers/6.jpg" alt="Speaker 6" className="img-fluid"/>
            <div className="details">
  ...
  <section id="venue" className="wow fadeInUp">
    ...
    <div className="container-fluid">
      ...
      <div className="row no-gutters">
        <div className="col-lg-6 venue-map">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621" frameBorder="0px" style={{ border: "0px"}} allowFullScreen></iframe>
        </div>
    ...
    <div className="container-fluid venue-gallery-container">
      <div className="row no-gutters">
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="img/venue-gallery/1.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/1.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/2.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/2.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/3.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/3.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/4.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/4.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/5.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/5.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/6.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/6.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/7.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/7.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-4">
          <div className="venue-gallery">
            <a href="../public/assets/img/venue-gallery/8.jpg" className="venobox" data-gall="venue-gallery">
              <img src="../public/assets/img/venue-gallery/8.jpg" alt="" className="img-fluid"/>
            </a>
          </div>
        </div>
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-md-6">
          <div className="hotel">
            <div className="hotel-img">
              <img src="../public/assets/img/hotels/1.jpg" alt="Hotel 1" className="img-fluid"/>
            </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="hotel">
            <div className="hotel-img">
              <img src="../public/assets/img/hotels/2.jpg" alt="Hotel 2" className="img-fluid"/>
            </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="hotel">
            <div className="hotel-img">
              <img src="../public/assets/img/hotels/3.jpg" alt="Hotel 3" className="img-fluid"/>
            </div>
  ...
  <section id="gallery" className="wow fadeInUp">
    ...
    <div className="owl-carousel gallery-carousel">
      <a href="../public/assets/img/gallery/1.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/1.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/2.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/2.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/3.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/3.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/4.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/4.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/5.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/5.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/6.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/6.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/7.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/7.jpg" alt=""/></a>
      <a href="../public/assets/img/gallery/8.jpg" className="venobox" data-gall="gallery-carousel"><img src="../public/assets/img/gallery/8.jpg" alt=""/></a>
    </div>
      ...
      <div className="row no-gutters sponsors-wrap clearfix">
        ...
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/1.png" className="img-fluid" alt=""/>
          </div>
        </div>
        
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/2.png" className="img-fluid" alt=""/>
          </div>
        </div>
      
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/3.png" className="img-fluid" alt=""/>
          </div>
        </div>
        
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/4.png" className="img-fluid" alt=""/>
          </div>
        </div>
        
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/5.png" className="img-fluid" alt=""/>
          </div>
        </div>
      
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/6.png" className="img-fluid" alt=""/>
          </div>
        </div>
        
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/7.png" className="img-fluid" alt=""/>
          </div>
        </div>
        
        <div className="col-lg-3 col-md-4 col-xs-6">
          <div className="sponsor-logo">
            <img src="../public/assets/img/sponsors/8.png" className="img-fluid" alt=""/>
          </div>
        </div>
